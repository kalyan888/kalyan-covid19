...
class CovidHome extends Component {
  ...
  getData = async () => {
    ...
    this.setState({statesName: states})
  ...
  updateState = (resultData, data) => {
    this.setState({result: resultData, covidData: data})
  }
          ...
          <div className="stat-container-1">
            <div className="stat-container">
              ...
              <img
                ...
                alt="confirmed-icon"
              />
              <h1 className="stat-count count-confirmed">{result.confirmed}</h1>
            </div>
            ...
            <div className="stat-container">
              ...
              <img
                ...
                alt="active-icon"
              />
              <h1 className="stat-count count-recovered">{result.recovered}</h1>
            </div>
          </div>
          <div className="stat-container-2">
            <div className="stat-container">
              ...
              <img
                ...
                alt="confirmed-icon"
              />
              <h1 className="stat-count count-active">{result.active}</h1>
            </div>
            ...
            <div className="stat-container">
              ...
              <img
                ...
                alt="active-icon"
              />
              <h1 className="stat-count count-deceased">{result.deceased}</h1>
            </div>
          </div>
        </div>
